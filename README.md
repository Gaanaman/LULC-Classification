...
The dataset, checkpoints, and outputs are gitignored — this repo holds code
only. Re-running the commands below regenerates them.
...
outputs/    checkpoints, reports, figures, logs (gitignored)
```
